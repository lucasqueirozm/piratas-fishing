        ...
        <div className="p-6 border-t border-gray-800 bg-[#111111] space-y-4">
          ...
          {cart.length > 0 && (
            <>
              ...
              <div className="pt-4 border-t border-gray-800">
                <h4 className="text-gray-400 font-bold uppercase text-sm mb-3">Forma de Pagamento</h4>
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    onClick={() => setPaymentMethod("PIX")}
                    className={`py-2 rounded-md font-bold border-2 transition-colors flex items-center justify-center gap-2 ${paymentMethod === "PIX" ? "border-[#FF6B00] bg-[#FF6B00]/10 text-[#FF6B00]" : "border-gray-700 text-gray-400 hover:border-gray-500"}`}
                  >
                    PIX
                  </button>
                  <button 
                    onClick={() => setPaymentMethod("Cartão de Crédito")}
                    className={`py-2 rounded-md font-bold border-2 transition-colors flex items-center justify-center gap-2 ${paymentMethod === "Cartão de Crédito" ? "border-[#FF6B00] bg-[#FF6B00]/10 text-[#FF6B00]" : "border-gray-700 text-gray-400 hover:border-gray-500"}`}
                  >
                    Cartão
                  </button>
                </div>
          ...
          <button 
            ...
            onClick={() => {
              ...
              const pagamentoText = `%0AForma de Pagamento: ${paymentMethod}`;
              
              const msg = `Olá, Piratas Fishing! Gostaria de finalizar meu pedido:%0A%0A${itemsText}${freteText}${pagamentoText}%0A%0A*Total: ${total}*`;
          ...
          >
            ...
            {paymentMethod ? 'Finalizar pelo WhatsApp' : 'Selecione o pagamento'}
          </button>
        </div>
      </div>
    </div>
